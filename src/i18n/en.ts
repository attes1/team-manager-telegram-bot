...
export const en: Translations = {
  ...
  status: {
    ...
    matchDayReminderSchedule: 'Match day reminder',
    menuCleanupSchedule: 'Menu cleanup',
    scheduleOff: 'off',
  },
  help: {
    ...
    devCommands: 'Developer Commands',
    ...
    commands: {
      ...
      devpoll: 'Schedule poll [minutes]',
      devreminder: 'Schedule reminder [minutes]',
      devmatchreminder: 'Schedule match day reminder [minutes]',
      devtrigger: 'Trigger scheduler task &lt;poll|reminder|matchreminder&gt;',
      devschedule: 'Show scheduler status',
    },
  },
  announcements: {
  ...
  dev: {
    notDevMode: 'Command only available in development mode.',
    pollScheduled: (minutes) => `Poll scheduled in ${minutes} minute(s).`,
    reminderScheduled: (minutes) => `Reminder scheduled in ${minutes} minute(s).`,
    matchReminderScheduled: (minutes) => `Match day reminder scheduled in ${minutes} minute(s).`,
    triggerUsage: 'Usage: /devtrigger <poll|reminder|matchreminder>',
    triggerInvalidTask: 'Unknown task. Use: poll, reminder, matchreminder',
    triggerStarted: (task) => `Task "${task}" started.`,
