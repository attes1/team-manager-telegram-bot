...
const commandsFi: BotCommand[] = [
  ...
  { command: 'match', description: 'Näytä matsitiedot ja linari' },
  { command: 'practice', description: 'Näytä treenien aikataulut' },
  ...
  { command: 'setlineup', description: 'Aseta matsin linari (admin)' },
  { command: 'poll', description: 'Lähetä aikataulukysely (admin)' },
